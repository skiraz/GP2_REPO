...
if __name__ == "__main__":
    ...
    cube = p.loadURDF(
    r"C:\Users\Rania\Desktop\GP2\qi_sdk\soda_can_tex.urdf",
    basePosition=[0.335, 0.05, .81],
    globalScaling=1,
    physicsClientId=client
)

# Load and apply the Coca-Cola can texture
    texture_id = p.loadTexture(r"C:\Users\Rania\Desktop\GP2\qi_sdk\pepsi.png")
    ...
    def camera_view(robot):
        ...
        while True:
            ...
            image_path = r"C:\Users\Rania\Desktop\GP2\qi_sdk\rgb.jpg"
            # model.plot(image_path, confidence=40, overlap=30, save_path="predicted_image.jpg")
            model.predict(image_path=image_path, confidence=40, overlap=30).save(r"C:\Users\Rania\Desktop\GP2\qi_sdk\rgb.jpg")
            print(model.predict(image_path, confidence=40, overlap=30).json())
            
            img  = cv2.imread( r"C:\Users\Rania\Desktop\GP2\qi_sdk\rgb.jpg")
