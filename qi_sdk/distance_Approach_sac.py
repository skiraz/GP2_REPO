...
class PepperEnv(gymnasium.Env):    
    ...
    def _setupScene(self):
        ...
        if self.soda :
            ...
            self.soda = p.loadURDF(
                r"C:\Users\Rania\Desktop\Graduation Project (ALL)\GP2\qi_sdk\soda_can_tex.urdf",
                basePosition=self.soda_pos,
                globalScaling=0.7,
                physicsClientId=self.client)
            texture_id = p.loadTexture(r"C:\Users\Rania\Desktop\Graduation Project (ALL)\GP2\qi_sdk\pepsi.png")
    ...
    def _getObservation(self):
        ...
        print(gripper_pose,gripper_rot)
    ...
    def camera_view(self,robot):
        ...
        for i in range(1):
            ...
            image_path = r"C:\Users\Rania\Desktop\Graduation Project (ALL)\GP2\qi_sdk\rgb1.jpg"
            # model.plot(image_path, confidence=40, overlap=30, save_path="predicted_image.jpg")
            self.model.predict(image_path=image_path, confidence=40, overlap=30).save(r"C:\Users\Rania\Desktop\Graduation Project (ALL)\GP2\qi_sdk\rgb_pred.jpg")
            x = self.model.predict(image_path, confidence=40, overlap=30).json()

            self.img  = cv2.imread( r"C:\Users\Rania\Desktop\Graduation Project (ALL)\GP2\qi_sdk\rgb_pred.jpg")
...
if __name__ == "__main__":
    ...
    model.learn(total_timesteps=1000 ,tb_log_name="A2C_inverse_threshold_newlist_lr")
    
    # model.learn(total_timesteps=30000 ,tb_log_name="ppo2_iter5")


    # model.save(os.path.join(env.models_dir,f"A2C_inverse_threshold_newlist_lr_{i}"))
    print("END OF LEARNING")
